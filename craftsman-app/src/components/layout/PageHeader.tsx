...
export default function PageHeader({ title, subtitle, backTo, action, className }: PageHeaderProps) {
  ...
  return (
    <div className={cn('bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 px-4 py-3 flex items-center gap-3 sticky top-[52px] z-20', className)}>
      {backTo && (
        <button
      ...
      <div className="flex-1 min-w-0">
        <h1 className="font-bold text-gray-900 dark:text-gray-100 text-base truncate">{title}</h1>
